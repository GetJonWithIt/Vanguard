...
public:
    ...
    static vector<double> evolveIntermediateConservedVariableVector2D(vector<double> leftConservedVariableVector, vector<double> middleConservedVariableVector,
    ...
    static void computeRungeKuttaTimeStep(vector<MHDIntermediateStateVector> & currentCells, vector<MHDIntermediateStateVector> & currentCellsWithBoundary, double cellSpacing, double timeStep,
    ...
    static void computeRungeKuttaTimeStep2D(vector<vector<MHDStateVector> > & currentCells, vector<vector<MHDStateVector> > & currentCellsWithBoundary, double cellSpacing, double timeStep,
                                            double bias, int slopeLimiter, MHDMaterialParameters materialParameters);
    static void computeRungeKuttaTimeStep2D(vector<vector<MHDIntermediateStateVector> > & currentCells, vector<vector<MHDIntermediateStateVector> > & currentCellsWithBoundary,
