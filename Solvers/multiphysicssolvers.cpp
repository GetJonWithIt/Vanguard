...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<MHDIntermediateStateVector> & currentCells, MHDMaterialParameters material1Parameters, MHDMaterialParameters material2Parameters)
{
    int interfaceLocation = 0;
    int cellCount = currentCells.size();
...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<vector<MHDIntermediateStateVector> > & currentCells, MHDMaterialParameters material1Parameters,
...
#pragma omp parallel for
    for (int i = 0; i < rowCount; i++)
    {
        ...
        for (int k = 0; k < interfaceCount1; k++)
        {
            ...
            {
                currentCells[i][j].relaxTotalDensity();
                currentCells[i][j].relaxTotalPressure();
...
#pragma omp parallel for
    for (int i = 0; i < columnCount; i++)
    {
        ...
        for (int k = 0; k < interfaceCount1; k++)
        {
            ...
            {
                currentCells[j][i].relaxTotalDensity();
                currentCells[j][i].relaxTotalPressure();
...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<MHDReducedStateVector> & currentCells, MHDMaterialParameters material1Parameters, MHDMaterialParameters material2Parameters)
{
    int interfaceLocation = 0;
    int cellCount = currentCells.size();
...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<vector<MHDReducedStateVector> > & currentCells, MHDMaterialParameters material1Parameters, MHDMaterialParameters material2Parameters)
{
    int rowCount = currentCells.size();
    int columnCount = currentCells[0].size();
...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<HPRMultiphysicsStateVector> & currentCells, HPRMaterialParameters material1Parameters, HPRMaterialParameters material2Parameters)
{
    int interfaceLocation = 0;
    int cellCount = currentCells.size();
...
#pragma omp parallel for
    ...
    for (int i = interfaceLocation - 2; i < interfaceLocation + 2; i++)
    {
        ...
        currentCells[i].relaxTotalPressure();
        currentCells[i].relaxTotalDistortionTensor();
        currentCells[i].relaxTotalXThermalImpulse();
        currentCells[i].relaxTotalYThermalImpulse();
        currentCells[i].relaxTotalZThermalImpulse();
...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<vector<HPRIntermediateStateVector> > & currentCells, HPRMaterialParameters material1Parameters, HPRMaterialParameters material2Parameters)
{
    int rowCount = currentCells.size();
    int columnCount = currentCells[0].size();
...
void MultiphysicsSolvers::reinitialiseVolumeFraction(vector<vector<HPRReducedStateVector> > & currentCells, HPRMaterialParameters material1Parameters, HPRMaterialParameters material2Parameters)
{
    int rowCount = currentCells.size();
    int columnCount = currentCells[0].size();
