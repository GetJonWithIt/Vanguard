...
void ElasticReducedTests::solveBartonTest1(int cellCount, int reinitialisationFrequency)
{
    ...
    outputSolution(SecondOrderSolver::solve(initialCells, cellSpacing, 0.8, 0.03, 0.0, 0, 0, reinitialisationFrequency, materialParameters, materialParameters));
}
...
void ElasticReducedTests::solveZhangTest(int cellCount, int reinitialisationFrequency)
{
    ...
    outputSolution(SecondOrderSolver::solve(initialCells, cellSpacing, 0.8, 0.025, 0.0, 0, 0, reinitialisationFrequency, material1Parameters, material2Parameters));
}
