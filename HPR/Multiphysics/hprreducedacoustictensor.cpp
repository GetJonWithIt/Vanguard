#include "hprreducedacoustictensor.h"

HPRReducedAcousticTensor::HPRReducedAcousticTensor()
{
}

vector<vector<double> > HPRReducedAcousticTensor::computeMaterial1AcousticTensorComponent1(HPRReducedStateVector stateVector, HPRMaterialParameters material1Parameters, int direction)
{
...
vector<vector<double> > HPRReducedAcousticTensor::computeMaterial2AcousticTensorComponent1(HPRReducedStateVector stateVector, HPRMaterialParameters material2Parameters, int direction)
{
...
vector<vector<double> > HPRReducedAcousticTensor::computeMaterial1AcousticTensorComponent2(HPRReducedStateVector stateVector, HPRMaterialParameters material1Parameters, int direction)
{
    vector<vector<double> > material1AcousticTensorComponent2(5, vector<double>(4));

    double material1Density = stateVector.getMaterial1Density();
    double interfacePressure = stateVector.getInterfacePressure();
    vector<vector<double> > interfaceDistortionTensor = stateVector.getInterfaceDistortionTensor();

    double material1AdiabaticSoundSpeed = HPRWaveSpeeds::computeAdiabaticSoundSpeed(material1Density, interfacePressure, material1Parameters);
...
vector<vector<double> > HPRReducedAcousticTensor::computeMaterial2AcousticTensorComponent2(HPRReducedStateVector stateVector, HPRMaterialParameters material2Parameters, int direction)
{
    ...
    double material2AdiabaticSoundSpeed = HPRWaveSpeeds::computeAdiabaticSoundSpeed(material2Density, interfacePressure, material2Parameters);
...
vector<vector<double> > HPRReducedAcousticTensor::computeMaterial1AcousticTensor(HPRReducedStateVector stateVector, HPRMaterialParameters material1Parameters, int direction)
{
...
vector<vector<double> > HPRReducedAcousticTensor::computeMaterial2AcousticTensor(HPRReducedStateVector stateVector, HPRMaterialParameters material2Parameters, int direction)
{
...
double HPRReducedAcousticTensor::computeMaximumWaveSpeed(HPRReducedStateVector stateVector, HPRMaterialParameters material1Parameters, HPRMaterialParameters material2Parameters, int direction)
{
