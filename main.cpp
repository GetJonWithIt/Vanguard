...
int main(int argc, char *argv[])
{
    ...
    //EulerMultiphysicsTests::solveFedkiwTest(200, 0);
    ...
    //ElasticTests::solve2DBartonTest1(20);
    ...
    //ElasticMultiphysicsTests::solveZhangTest(100, 3);

    //ElasticReducedTests::solveBartonTest1(100, 3);
    //ElasticReducedTests::solveZhangTest(100, 0);
    //ElasticReducedTests::solve2DBartonTest1(20, 3);
    ElasticReducedTests::solve2DZhangTest(50, 3);
